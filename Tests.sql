...
INSERT INTO [Library].[dbo].[Library]
...
VALUES (
    @LibraryId, 'LibraryTest', 'Street', '123', 'District', 'City', 'Zipcode', 'State', 'CountryCode',
    'Observation', 0, 0, GETDATE(), GETDATE(), 0
);

INSERT INTO [Library].[dbo].[Role]
...
INSERT INTO [Library].[dbo].[UserRole]
(UserId, RoleId)
